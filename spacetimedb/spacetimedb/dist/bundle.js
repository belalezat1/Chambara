...
function normalizeRoomCode(roomCode) {
	...
	if (!ROOM_RE.test(room)) throw new SenderError("Room code must be 6 letters or digits.");
	return room;
}
function countPlayersInRoom(ctx, roomCode) {
	return [...ctx.db.matchPlayer.roomCode.filter(roomCode)].length;
}
function emptyPose(identity, roomCode, ms) {
	return {
		identity,
		roomCode,
		type: PRIMARY_GRIP,
...
const createOrJoinMatch = spacetimedb.reducer({ roomCode: t.string() }, (ctx, { roomCode: rawRoom }) => {
	...
	const ms = nowMs(ctx);
	if (!matchRow) matchRow = ctx.db.match.insert({
		roomCode,
		hostIdentity: ctx.sender,
		createdMs: ms
	});
	else if (countPlayersInRoom(ctx, roomCode) >= 2) throw new SenderError("Match is full.");
...
const leaveMatch = spacetimedb.reducer((ctx) => {
	const player = ctx.db.matchPlayer.identity.find(ctx.sender);
	if (!player) return;
	const roomCode = player.roomCode;
	ctx.db.swordPose.identity.delete(ctx.sender);
...
const setReady = spacetimedb.reducer({ ready: t.bool() }, (ctx, { ready }) => {
	const player = ctx.db.matchPlayer.identity.find(ctx.sender);
	if (!player) throw new SenderError("Join a match before setting ready.");
	ctx.db.matchPlayer.identity.update({
		...player,
		ready
	});
});
const updateSwordPose = spacetimedb.reducer({
	type: t.string(),
	...
	if (type !== PRIMARY_GRIP) throw new SenderError("type must be \"primary-grip\".");
	if (position.length !== 3 || rotation.length !== 4) throw new SenderError("position must be [x,y,z] and rotation [x,y,z,w].");
	if (!position.every((v) => Number.isFinite(v)) || !rotation.every((v) => Number.isFinite(v))) throw new SenderError("position and rotation must be finite.");
	const row = {
		identity: ctx.sender,
	...
	if (ctx.db.swordPose.identity.find(ctx.sender)) ctx.db.swordPose.identity.update(row);
	else ctx.db.swordPose.insert(row);
});
const upsertCombatIntent = spacetimedb.reducer({
	blocking: t.bool(),
	slashSeq: t.u32(),
	guardX: t.f32(),
	guardY: t.f32()
	...
	if (![guardX, guardY].every(Number.isFinite)) throw new SenderError("guard must be finite.");
	const row = {
		identity: ctx.sender,
		roomCode: player.roomCode,
		blocking,
	...
	if (ctx.db.combatIntent.identity.find(ctx.sender)) ctx.db.combatIntent.identity.update(row);
	else ctx.db.combatIntent.insert(row);
});
const publishCombatOutcome = spacetimedb.reducer({
	seq: t.u32(),
	kind: t.string(),
	actorIdentity: t.identity(),
	targetIdentity: t.identity(),
	...
	if (!matchRow || !matchRow.hostIdentity.equals(ctx.sender)) throw new SenderError("Only the host may publish match authority.");
	const roomCode = player.roomCode;
	if (!OUTCOME_KINDS.has(args.kind)) throw new SenderError("Invalid combat outcome kind.");
	if (![args.playerRootX, args.dummyRootX].every(Number.isFinite)) throw new SenderError("roots must be finite.");
	const row = {
		roomCode,
		seq: args.seq,
		kind: args.kind,
	...
	} else ctx.db.combatOutcome.insert(row);
});
const resetMatchCombat = spacetimedb.reducer((ctx) => {
	const player = ctx.db.matchPlayer.identity.find(ctx.sender);
	if (!player) throw new SenderError("Join a match first.");
	const matchRow = ctx.db.match.roomCode.find(player.roomCode);
	if (!matchRow || !matchRow.hostIdentity.equals(ctx.sender)) throw new SenderError("Only the host may publish match authority.");
...
//#endregion
export { createOrJoinMatch, spacetimedb as default, init, leaveMatch, onConnect, onDisconnect, publishCombatOutcome, resetMatchCombat, setReady, updateSwordPose, upsertCombatIntent };
//# debugId=0f8b5673-01f9-4d00-85de-74985a0108f8
//# sourceMappingURL=data:application/json;charset=utf-8;base64,